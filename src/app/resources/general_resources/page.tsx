  ...
  const resume_coverletterTemplates = [
    {
      ...
      imageSrc: `${basePath}/main_logos_and_assets/assets/harvard_template_resized.webp`,
    ...
    },
    {
      ...
      imageSrc: `${basePath}/main_logos_and_assets/assets/jakes_template_resized.webp`,
      buttonText: "View Resume Template",
      buttonLink: "https://docs.google.com/document/d/1Z9sB5bg5lbZSQKVT9rAaHGZdMHEP_TpG/copy",
    },
     {
      title: "Harvard Cover Letter Template",
      imageSrc: `${basePath}/main_logos_and_assets/assets/harvard_cl_template_resized.webp`,
    ...
    },
    {
      ...
      imageSrc: `${basePath}/main_logos_and_assets/assets/princeton_cl_template_resized.webp`,
      buttonText: "View Cover Letter Template",
  ...
  const careerServices = [
    {
      ...
      imageSrc: `${basePath}/main_logos_and_assets/assets/pamplin_career_services_resized.webp`,
    ...
    },
    {
      ...
      imageSrc: `${basePath}/main_logos_and_assets/assets/vt_cpd_resized.webp`,
